    ...
    def process_algorithm(
        ...
        if str(base_raster_path).startswith("NETCDF"):
            ...
            if base_raster_path.stem == path_static.split('.')[0]:
                feedback.pushWarning(f"WARNING: You are using the landuse layer generated by Wflow, this layer has a smaller resolution than the actual landuse input layer")
